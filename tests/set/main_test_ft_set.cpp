...
#include "../../srcs/set/node_tree_set.hpp"
...
int main() {
	...
	std::cout << "----------------------- FT CONSTRUCTOR / Operator -----------------------" << std::endl; 
	{
		...
		for (ft::set<char>::iterator it=set2.begin(); it!=set2.end(); ++it)
			std::cout << *it << " => " << *it << '\n';
		std::cout << std::endl;
		std::cout << "set<int, int, classcomp> contains:\n";
		for (ft::set<int, classcomp>::iterator it=set3.begin(); it!=set3.end(); ++it)
			std::cout << *it << " => " << *it << '\n';
	}
	std::cout << "----------------------------------------------------------------------------------------------------" << std::endl << std::endl;
	{
		...
		for (ft::set<char>::iterator it=set2.begin(); it!=set2.end(); ++it)
			std::cout << *it << " => " << *it << '\n';
		std::cout << std::endl;
		ft::set<int> set_cpy(set.begin(), set.end());
		std::cout << "set_cpy<int, int> contains:\n";
		for (ft::set<int>::iterator it=set.begin(); it!=set.end(); ++it)
			std::cout << *it << " => " << *it << '\n';
		std::cout << std::endl;
		ft::set<char> set2_cpy(set2.find('c'), set2.end());
		std::cout << "set2_cpy<char, char> (Start from c) contains:\n";
		for (ft::set<char>::iterator it=set2_cpy.begin(); it!=set2_cpy.end(); ++it)
			std::cout << *it << " => " << *it << '\n';
		std::cout << std::endl;
	}
	std::cout << "----------------------------------------------------------------------------------------------------" << std::endl << std::endl;
	{
		...
		ft::set<int> set_cpy(set);
		std::cout << "set_cpy<int, int> contains:\n";
		for (ft::set<int>::iterator it=set.begin(); it!=set.end(); ++it)
			std::cout << *it << " => " << *it << '\n';
		std::cout << std::endl;
		ft::set<char> set2_cpy(set2);
...
std::cout << "void insert (InputIterator first, InputIterator last);" << std::endl << std::endl;
		...
		for (ft::set<char>::iterator it=set3.begin(); it!=set3.end(); ++it)
			std::cout << *it << " => " << *it << '\n';
		...
		for (ft::set<char>::iterator it=set4.begin(); it!=set4.end(); ++it)
			std::cout << *it << " => " << *it << '\n';
		...
		std::cout << std::endl;
		ft::set<char> set6;
		ft::set<char>::iterator it = set4.begin();
		std::cout << "Insert from begin to begin++ of set4" << std::endl;
		set6.insert(it, ++it);			
		std::cout << "set6<char, char> contains:\n";
		for (ft::set<char>::iterator it=set6.begin(); it!=set6.end(); ++it)
			std::cout << *it << " => " << *it << '\n';
	}
	std::cout << "----------------------------------------------------------------------------------------------------" << std::endl << std::endl;
	{
	...
	std::cout << "----------------------- FT Key_comp -----------------------" << std::endl; 
	{
		...
		ft::set<int, classcomp> myset2;
		int highest2;

		ft::set<int, classcomp>::key_compare mycomp2 = myset2.key_comp();
		...
		ft::set<int, classcomp>::iterator it2=myset2.begin();
		do {
			std::cout << ' ' << *it2;
	...
	std::cout << "----------------------- Ft Iterators -----------------------" << std::endl; 
	{
		...
		ft::set<int>::reverse_iterator reverse_it = set.rend();
		...
		for (ft::set<int>::iterator begin = set.begin(); begin != set.end(); begin++)
			std::cout << "First = " << *begin << std::endl;
		std::cout << std::endl;

		std::cout << "set Contain (Reverse) : " << std::endl;
		for (ft::set<int>::iterator end = set.end(); end != set.begin();) {
			end--;
		...
		ft::set<int>::iterator cpy_begin = begin;
		...
		set2.insert(112);
		ft::set<int>::iterator it2 = set2.end();
		ft::set<int>::reverse_iterator reverse_it2 = set2.rend();
