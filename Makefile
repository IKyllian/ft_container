...
$(VECTOR) : $(VECTOR_OBJS) $(STACK_OBJS) $(MAP_OBJS) $(STD_VECTOR_OBJS) $(STD_STACK_OBJS) $(STD_MAP_OBJS) $(HEADER) 
...
clean :	
	$(RM) $(VECTOR_OBJS) $(STACK_OBJS) $(MAP_OBJS)
	$(RM) $(STD_VECTOR_OBJS) $(STD_STACK_OBJS) $(STD_MAP_OBJS)

fclean : clean
	$(RM) $(VECTOR) $(STACK) $(MAP) $(STD_VECTOR) $(STD_STACK) $(STD_MAP)
